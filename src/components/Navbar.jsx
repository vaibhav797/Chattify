...
const Navbar = () => {
  ...
  return (
    <div className='box flex items-center flex-wrap justify-center gap-2 min-[1035px]:justify-between min-[1035px]:gap-0 px-2 py-4 rounded-tl-lg text-indigo-200 bg-[#2f2d57]'>
      <span className='font-semibold text-2xl '>Chattify</span>
